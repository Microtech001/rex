...
cd /usr/bin
wget -O addss-p "https://raw.githubusercontent.com/Microtech001/rex/main/shadowsocks-plugin/addss-p.sh"
chmod +x addss-p
#wget -O shadowhost "https://raw.githubusercontent.com/Microtech001/rex/main/shadowsocks-plugin/shadowhost.sh"
#chmod +x shadowhost && shadowhost
wget -O delss "https://raw.githubusercontent.com/Microtech001/rex/main/shadowsocks/delss.sh"
cd
...
rm -rf gost-plugin
cd /usr/bin/
wget -O gost-plugin "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/gost-plugin"
wget -O v2ray-plugin "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/v2ray-plugin"
wget -O xray-plugin "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/xray-plugin"
chmod +x gost-plugin
...
wget -O gost-plugin-arm.zip "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/gost-plugin-arm.zip"
wget -O gost-plugin-x86.zip "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/gost-plugin-x86.zip"
wget -O v2ray-plugin-universal.apk "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/v2ray-plugin-universal-v4.44.0.apk"
wget -O xray-plugin-universal.apk "https://raw.githubusercontent.com/Microtech001/Shadowsocks-Plugin/main/xray-plugin-universal-v1.5.4.apk"
...
#rm -rf acme.sh
#rm -rf .acme.sh
#wget -O acme.sh https://raw.githubusercontent.com/Microtech001/rex/main/acme.sh
#bash acme.sh --install
#rm acme.sh
#cd .acme.sh
#bash acme.sh --register-account -m microtechstore001@gmail.com
