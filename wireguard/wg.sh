...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/Microtech001/rex/main/wireguard"
...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard dah instal, sila klik addwg untuk menambah client."
	exit 1
fi

echo -e "${Info} Wireguard Script By MTS"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Microtech001/rex/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Microtech001/rex/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Microtech001/rex/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
