...
echo -e "\033[0;36m#|'....|'.||.'|..|'  |   |  .||...|'.|.   '||'....|'#\033[m"
echo -e "\033[0;36m#---------------------------------------------------#\033[m"
echo -e "\033[0;36m#\033[m \033[0;31mSlowDNS | MTS\033[m \033[0;36m#\033[m"
echo -e "\033[0;36m#===================================================#\033[m"
    echo ""
    ...
    echo -e "\033[0;36m[05]\033[m | Tengok informasi"
    echo -e "\033[0;36m[06]\033[m | Mula SlowDNS"
    echo -e "\033[0;36m[07]\033[m | Mula Balik SlowDNS"
    echo -e "\033[0;36m[08]\033[m | hentikan SlowDNS"
    echo -e "\033[0;36m[09]\033[m | Padam SlowDNS"
    echo -e "\033[0;36m[10]\033[m | Perbarui/Instal Ulang"
    echo -e "\033[0;36m[11]\033[m | Padam Script"
    echo -e "\033[0;36m[00]\033[m | KELUAR"
    echo ""
    echo -ne "\033[0;36mO apa yang ko nak buat?:\0033[m " && read opcao
    case $opcao in
    1) Opcao1 ;;
    2) Opcao2 ;;
    3) Opcao3 ;;
